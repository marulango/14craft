...
function checkParams(params) {
  ...
  var _params$split$map = params.split(SEPARATOR).map(function (str) {
    return str.trim();
      ...
      _params$split$map2 = _slicedToArray(_params$split$map, 2),
      name = _params$split$map2[0],
      values = _params$split$map2[1];
...
function paramsList(params) {
  var _params$split$map3 = params.split(SEPARATOR).map(tokenize),
      _params$split$map4 = _slicedToArray(_params$split$map3, 2),
      vars = _params$split$map4[0],
      values = _params$split$map4[1];
